...
# Librería para exportar valores como json
import json
...
class carAgent(Agent):
    ...
    def step(self):
        ...
        if self.big_lane == 1:
            ...
            if (self.lane == 1 and light.color == 1) or currentX >= 29:
                if currentX < targetX:
            ...
            if self.lane == 2 and light.color == 1 or currentX >= 29:
                if currentX < targetX:
                    self.model.grid.move_agent(self, (currentX + 1, currentY))
                    self.direccion = "derecha"
        ...
        if self.big_lane == 3:
            ...
            if (self.lane == 1 and light.color == 1) or currentX <= 34:
                if currentX > targetX:
                    self.model.grid.move_agent(self, (currentX - 1, currentY))
            ...
            if (self.lane == 2 and light.color == 1) or currentX <= 34:
                if currentX > targetX:
                    self.model.grid.move_agent(self, (currentX - 1, currentY))
                    self.direccion = "izquierda"
        ...
        if self.big_lane == 2:
            ...
            if (self.lane == 1 and light.color == 1) or currentY <= 34:
                if currentY > targetY:
                    self.model.grid.move_agent(self, (currentX, currentY - 1))
                    self.direccion = "abajo"
                else:
            ...
            if (self.lane == 2 and light.color == 1) or currentY <= 34:
                if currentY > targetY:
                    self.model.grid.move_agent(self, (currentX, currentY - 1))
                    self.direccion = "abajo"
        ...
        if self.big_lane == 4:
            ...
            if (self.lane == 1 and light.color == 1) or currentY >= 29:
                if currentY < targetY:
                    self.model.grid.move_agent(self, (currentX, currentY + 1))
                else:
                    if currentX < targetX:
            ...
            if (self.lane == 2 and light.color == 1) or currentY >= 29:
                if currentY < targetY:
                    self.model.grid.move_agent(self, (currentX, currentY + 1))
